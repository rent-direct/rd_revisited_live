...
<div id="page-wrapper">
    ...
    <form id="fileupload" action="<? echo base_url('landlord/add_property_images') ?>" method="POST" enctype="multipart/form-data">
        ...
        <!--- ID SELECTOR ---->
        <input type="hidden" name="prop_select_id" id="prop_select_id" value="<? echo $id; ?>">
    </form>
