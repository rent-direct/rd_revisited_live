var UnrealEstate = {
    init : function() {
        ...
        //---------------------drop down menu-----------------------//
        jQuery('.header-buttons .add').click(function() {
            var $this = $(this);
        ...
        jQuery('.header-buttons .contact').click(function() {
            var $this = $(this);
            if($('#hidden-header').hasClass('open')) {
                if($('.header-buttons .add').hasClass('closed')) {
                    $this.addClass('closed').attr('data-original-title', 'Close');
                    $('.header-buttons .add').removeClass('closed').attr('data-original-title', 'Go to My Profile');
                    $('#hidden-header .add-form').fadeOut('fast', function() {
