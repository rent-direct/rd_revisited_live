    ...
    <section class='container'>
        <section class='row'>
            <div class='span8'>
                ...
                <p>The extensive range of functionality provided to advertisers on Rent Direct is immense. This list is by no means exhaustive and we will regularly update this page as we add new features.</p>
            </div>
        </section>
    </section>
</section>
            ...
            <div class='span9'>
                <div class='description-box open' rel='1'>
                    <div class='inner'>
                        <div class='inner-container'>
                            <!---- Start of upcoming listing container ---->
                        ...
                        <!---- End of upcoming listing container ---->
                    </div>
                </div>
                <div class='description-box' rel='4'>
                    <div class='inner'>
                        <div class='inner-container'>
                            <figure>
                                <img src="<? echo base_url() ?>assets/img/photos/4834790926_0228ed6cde_b.jpg" alt="" />
                            </figure>
                            <h2>Methodology</h2>
