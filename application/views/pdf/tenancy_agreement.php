...
<table width="100%" border="0">
  ...
  <tr>
    <td colspan="2" class="Header1"><img src="http://rent-direct.co.uk/assets/img/logo-footer.png" alt="Rent Direct" name="Rent_Direct_Logo" width="282" height="51" id="Rent_Direct_Logo" align="center" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2" class="property_address">Property: <?=$address?></td>
  ...
  <tr>
    ...
    <td width="27%" class="side-h3">Date:</td>

    <td width="73%"><?=$tenancy_agreement_date?></td>
  ...
  <tr>
    ...
    <td>obtain and maintain a policy of insurance with a ruptable insurance company to provide not less than &pound;2,500 of cover for accidental damage to the property, fixtures and fittings and possessions; and</td>
  ...
  <tr>
    ...
    <td colspan="2" class="notes">Note: The definition of &#39;Property&#39; means that this clause applies to dealings with any part of the Property as well as to dealings with the whole of it.</td>
  ...
  <tr>
    ...
    <td>the Property and the Landlord&#39;s Items (but not the Tenant&#39;s possessions and fittings) for a sum sufficient to cover the cost of reinstatement assuming total loss including all applicable VAT and ancillary costs (such as site clearance and professional fees) and an appropriate allowance for inflation.</td>
  ...
  <tr>
    ...
    <td>To keep the outside of the Property (except the glass) and the floor, walls and structure of the Property in good repair and condition.</td>
  ...
  <tr>
    ...
    <td>The tenancy is for a fixed term of not more than 12 months and at some time during the 12 months before the tenancy started, the property was let to students by an educational establishment such as a university or college.</td>
  ...
  <tr>
    ...
    <td colspan="2">The Landlord notifies the Tenant that the Tenant may serve notices (including notices in proceedings) on the Landlord at the following address:</td>
  ...
  <tr>
    ...
    <td colspan="2">If there remains an unresolved dispute between the Landlord and Tenant after 10 working days after notifictaion of a dispute, the dispute may be submitted to the tenancy deposit scheme&#39;s Independent Case Examiner.</td>
  ...
  <tr>
    ...
    <td>The Tenant confirms that he / she has been given the opportunity to examine this information. The Tenant confirms by signing this document that to the knowledge of the Tenant the information above is accurate to the best of his knowledge and belief.</td>
