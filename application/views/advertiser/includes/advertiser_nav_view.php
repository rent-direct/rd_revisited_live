...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="<? echo base_url('landlord/tenants') ?>"><i class="fa fa-child fa-fw"></i> Tenants</a>
            </li>

            <li>
                <a href="<? echo base_url('landlord/ratings') ?>"><i class="fa fa-star fa-fw"></i> Ratings</a>
            </li>

            <li>
                <a href="<? echo base_url('landlord/add') ?>"><i class="fa fa-plus fa-fw"></i> Add Property</a>
            </li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="panels-wells.html">User Settings</a>
                    </li>
                    <li>
                        <a href="buttons.html">Edit Property</a>
                    </li>
                    </ul>
            </li>
